/**
 * Server-side abuse-report evidence validation and moderation status machine (Issue #241).
 *
 * Keep in sync with src/lib/reports/abuseEvidence.ts — same rules for API enforcement.
